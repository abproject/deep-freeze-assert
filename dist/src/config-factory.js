...
exports.configFactory = config => {
    if (config && config.silent === true) {
        return Object.assign({}, config_default_1.configDefault, {
            setFn: set_throw_silent_1.setThrowSilent,
            deletePropertyFn: delete_property_throw_silent_1.deletePropertyThrowSilent
        }, config);
    }
